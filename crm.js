...
const PITCHES = [
  { id: "p1", name: "باقة التسويق الرقمي" },
  { id: "p2", name: "نظام إدارة الحجوزات" },
  { id: "p3", name: "خدمة التصوير الاحترافي" },
  { id: "p4", name: "الإعلان في الدليل" },
  { id: "p5", name: "خدمة إدارة التقييمات" },
  { id: "p6", name: "أخرى" },
];
